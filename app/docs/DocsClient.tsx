        ...
        <div className="min-h-screen bg-[#0a0a0c] overflow-x-hidden">
            ...
            <section className="px-6 md:px-12 pb-8">
                <motion.a
                    ...
                    className="block max-w-4xl mx-auto p-6 md:p-8 rounded-2xl border border-emerald-500/15 bg-emerald-500/[0.03] hover:bg-emerald-500/[0.06] hover:border-emerald-500/25 transition-all duration-300 group cursor-pointer"
                >
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-white mb-0.5 tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                                    Getting Started Guide
                                </h3>
                                <p className="text-white/35 text-sm font-light">
                                    Set up your AI chatbot in 5 minutes — step-by-step visual walkthrough
                                </p>
                            </div>
                        </div>
                        <ArrowRight size={18} className="text-white/15 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all duration-300 shrink-0" />
                    </div>
                </motion.a>
            </section>
