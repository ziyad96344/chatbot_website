...
const fallbackPlans: SubscriptionPlan[] = [ { id: 1, name: 'Starter', slug: 'starter', description: 'Perfect for small websites to automate basic support.', features: ['1 Chatbot', '500 Messages/mo', 'Basic Analytics', 'Email Support'], price_monthly: 0, price_yearly: 0, is_active: true, sort_order: 1, chatbot_limit: 1, message_limit: 500, voice_enabled: false, whatsapp_enabled: false, api_access: false, priority_support: false, branding_removable: false }, { id: 2, name: 'Growth', slug: 'growth', description: 'Ideal for growing businesses needing omnichannel.', features: ['3 Chatbots', '5,000 Messages/mo', 'WhatsApp Integration', 'Priority Support'], price_monthly: 2999, price_yearly: 29990, is_active: true, sort_order: 2, chatbot_limit: 3, message_limit: 5000, voice_enabled: false, whatsapp_enabled: true, api_access: false, priority_support: true, branding_removable: false }, { id: 3, name: 'Professional', slug: 'professional', description: 'Advanced AI features for professional teams.', features: ['10 Chatbots', '20,000 Messages/mo', 'Voice AI Enabled', 'Remove Branding'], price_monthly: 7999, price_yearly: 79990, is_active: true, sort_order: 3, chatbot_limit: 10, message_limit: 20000, voice_enabled: true, whatsapp_enabled: true, api_access: true, priority_support: true, branding_removable: true }, { id: 4, name: 'Enterprise', slug: 'enterprise', description: 'Custom AI solutions for large-scale operations.', features: ['Unlimited Chatbots', 'Unlimited Messages', 'Custom LLM Training', 'Dedicated Manager'], price_monthly: 0, price_yearly: 0, is_active: true, sort_order: 4, chatbot_limit: -1, message_limit: -1, voice_enabled: true, whatsapp_enabled: true, api_access: true, priority_support: true, branding_removable: true } ];
...
const PricingPage: React.FC = () => {
        ...
        const fetchPlans = async () => {
            try {
                ...
                if (data.success && data.data) {
                    ...
                    console.error('API Error:', data.message || 'Unknown error'); setPlans(fallbackPlans);
                }
            } catch (err) {
    ...
    // Handle plan selection â€” redirect to chatbot frontend registration
    const handleSelectPlan = (plan: SubscriptionPlan) => {
        // Enterprise / custom pricing â€” go to contact page
            ...
            <div className="w-full max-w-[1400px] mx-auto px-6 relative z-10 flex flex-col pt-20 md:pt-24 pb-20">
                ...
                <div className="absolute bottom-6 left-0 w-full text-center pointer-events-auto">
                    <p className="text-white/20 text-[10px] tracking-widest uppercase">
                        Secure 256-bit Encryption â€¢ Global CDN â€¢ 99.99% Uptime
                    </p>
