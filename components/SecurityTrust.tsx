...
const SecurityTrust: React.FC = () => {
    ...
    return (
        <section ref={sectionRef} className="min-h-screen py-20 px-6 md:px-12 bg-[#030303] relative overflow-hidden flex flex-col items-center justify-center border-t border-white/[0.05]">
            
            {/* Dark Security Ambient Lighting */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] h-[600px] bg-red-900/10 blur-[150px] rounded-full" />
            </div>
            ...
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center relative z-10 mx-auto">
                ...
                <div ref={boxRef} className="order-2 lg:order-1 flex flex-col gap-4">
                    {securityFeatures.map((feat, idx) => (
                        <div key={idx} className="bg-[#030303] border border-orange-500/20 rounded-xl max-w-lg p-5 flex gap-4 hover:border-orange-500/50 hover:bg-white/[0.02] transition-all duration-300">
                            <div className="w-10 h-10 shrink-0 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center mt-1">
                                {feat.icon}
                            </div>
                            <div>
                ...
                <div ref={textRef} className="order-1 lg:order-2 text-center lg:text-left">
                    ...
                    >
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-400">Never Compromised</span>
                    </h2>
                    ...
                    <div className="inline-flex items-center gap-2 px-5 py-3 bg-red-500/10 border border-red-500/20 rounded-full text-xs font-bold text-red-500 uppercase tracking-widest">
                       <span className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center mr-1 shadow-[0_0_15px_rgba(239,68,68,0.4)]">
